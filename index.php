...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <meta name="keywords" content="台前 励志中学 台前县一高 台前县一中 思源实验学校 教育 学校 小学 中学">
    <meta name="description" content="台前生活、教育平台">
	    ...
	    <table align=left cellpadding=0 cellspace=0 border=0>
		  <tr>
		    <div id="demo1" style="width:100%;">
			  <span style="text-align:center;line-height:20px;white-space:nowrap;width:400px;">
  ...
  demo.onmouseout=function() {MyMar=setInterval(Marquee,speed)}
		    ...
		    <div style="padding:5px;font:12px/1.5 tahoma,arial,宋体;height:230px;overflow:hidden;">
			  ...
			  <table id="marqueebox" style="width:100%;">
				<tr style="font-size:13px;padding:1px;color:#3E3E3E;line-height:22px;">
				  ...
				  <td>
				    <a href="news/2.php">台前网正式上线</a></td><td width="72px;">2014-08-04</td>
				</tr>
				<tr style="font-size:13px;padding:1px;color:#3E3E3E;line-height:22px;">
		...
		<div id="second" style="width:100%;padding:10px;font:12px/1.5 tahoma,arial,宋体;">
		    <?php 
				$values = array(
					array("name"=>"励志中学","url"=>"lizhi","type"=>"初中 高中"),
					array("name"=>"思源实验学校","url"=>"siyuan","type"=>"小学 初中"),
					array("name"=>"台前县一中","url"=>"#","type"=>"初中"),
					array("name"=>"台前县一高","url"=>"#","type"=>"高中"),
					array("name"=>"城镇中学","url"=>"#","type"=>"初中"),
					
					array("name"=>"凤鸣小学","url"=>"#","type"=>"小学"),
					array("name"=>"曹杨韩小学","url"=>"cyh","type"=>"小学"),
					array("name"=>"幸福小学","url"=>"#","type"=>"小学"),
					array("name"=>"城镇小学","url"=>"#","type"=>"小学"),
					
					array("name"=>"清华小博士幼儿园","url"=>"xiaoboshi","type"=>"幼儿园"),
					
					array("name"=>"艺园幼儿园","url"=>"yiyuan","type"=>"幼儿园"),
					array("name"=>"台前新区医院","url"=>"#","type"=>"其他")
				);
				$numbers = count($values);
				for($i=0;$i<$numbers;$i++){
			?>
			<div id="service">
			<a href="<?php echo '/'.$values[$i]["url"]?>" target="_blank">
		    <div id="service_2">
		      <div id="name">
			    <img style="width:100%;" src="tq/images/<?php echo $i%7+1?>.jpg" alt="<?php echo $values[$i]["name"]."@台前网"?>">
			    <span><?php echo $values[$i]["name"]?></span>
			  </div>
			  <div id="content_2">
			    <span><?php echo $values[$i]["type"]?></span><br />
				<span>电话：0393-*******</span><br />
				<span>位置：台前县******</span>
			  </div>
		    </div>
			</a>
